...
function nd_travel_meta_box_save_cpt_3( $post_id )
{
    ...
    //preview settings
    $nd_travel_meta_box_color_cpt_3 = sanitize_hex_color( $_POST['nd_travel_meta_box_color_cpt_3'] );
    if ( isset( $nd_travel_meta_box_color_cpt_3 ) ) { 

      if ( $nd_travel_meta_box_color_cpt_3 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_color_cpt_3' , $nd_travel_meta_box_color_cpt_3 );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_color_cpt_3');
      }
  
    }

    $nd_travel_meta_box_icon_cpt_3 = esc_url_raw( $_POST['nd_travel_meta_box_icon_cpt_3'] );
    if ( isset( $nd_travel_meta_box_icon_cpt_3 ) ) { 

      if ( $nd_travel_meta_box_icon_cpt_3 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_icon_cpt_3' , $nd_travel_meta_box_icon_cpt_3 ); 
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_icon_cpt_3');
      }
  
    }

    $nd_travel_meta_box_text_preview_cpt_3 = sanitize_meta('nd_travel_meta_box_text_preview_cpt_3',$_POST['nd_travel_meta_box_text_preview_cpt_3'],'post');
    if ( isset( $nd_travel_meta_box_text_preview_cpt_3 ) ) { 

      if ( $nd_travel_meta_box_text_preview_cpt_3 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_text_preview_cpt_3' , $nd_travel_meta_box_text_preview_cpt_3 ); 
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_text_preview_cpt_3');
      }

    }

    $nd_travel_meta_box_parent_destination = sanitize_meta('nd_travel_meta_box_parent_destination',$_POST['nd_travel_meta_box_parent_destination'],'post');
    if ( isset( $nd_travel_meta_box_parent_destination ) ) { 

      if ( $nd_travel_meta_box_parent_destination != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_parent_destination' , $nd_travel_meta_box_parent_destination ); 
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_parent_destination');
      }
 
    }

    //page settings
    $nd_travel_meta_box_image_cpt_3 = esc_url_raw( $_POST['nd_travel_meta_box_image_cpt_3'] );
    if ( isset( $nd_travel_meta_box_image_cpt_3 ) ) { 

      if ( $nd_travel_meta_box_image_cpt_3 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_image_cpt_3' , $nd_travel_meta_box_image_cpt_3 );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_image_cpt_3');
      }
    
    }

    $nd_travel_meta_box_image_cpt_3_position = sanitize_option( 'nd_travel_meta_box_image_cpt_3_position', $_POST['nd_travel_meta_box_image_cpt_3_position'] );
    if ( isset( $nd_travel_meta_box_image_cpt_3_position ) ) { 

      if ( $nd_travel_meta_box_image_cpt_3_position != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_image_cpt_3_position' , $nd_travel_meta_box_image_cpt_3_position );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_image_cpt_3_position');
      }
   
    }

    $nd_travel_meta_box_page_layout_cpt_3 = sanitize_option( 'nd_travel_meta_box_page_layout_cpt_3', $_POST['nd_travel_meta_box_page_layout_cpt_3'] );
    if ( isset( $nd_travel_meta_box_page_layout_cpt_3 ) ) { 

      if ( $nd_travel_meta_box_page_layout_cpt_3 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_page_layout_cpt_3' , $nd_travel_meta_box_page_layout_cpt_3 );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_page_layout_cpt_3');
      }
   
    }

    //info box
    $nd_travel_meta_box_country_title_cpt_3 = sanitize_meta('nd_travel_meta_box_country_title_cpt_3',$_POST['nd_travel_meta_box_country_title_cpt_3'],'post');
    if ( isset( $nd_travel_meta_box_country_title_cpt_3 ) ) { 

      if ( $nd_travel_meta_box_country_title_cpt_3 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_country_title_cpt_3' , $nd_travel_meta_box_country_title_cpt_3 );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_country_title_cpt_3');
      }

    }

    $nd_travel_meta_box_country_descr_cpt_3 = sanitize_meta('nd_travel_meta_box_country_descr_cpt_3',$_POST['nd_travel_meta_box_country_descr_cpt_3'],'post');
    if ( isset( $nd_travel_meta_box_country_descr_cpt_3 ) ) { 

      if ( $nd_travel_meta_box_country_descr_cpt_3 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_country_descr_cpt_3' , $nd_travel_meta_box_country_descr_cpt_3 ); 
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_country_descr_cpt_3');
      }

    }

    $nd_travel_meta_box_contact_title_cpt_3 = sanitize_meta('nd_travel_meta_box_contact_title_cpt_3',$_POST['nd_travel_meta_box_contact_title_cpt_3'],'post');
    if ( isset( $nd_travel_meta_box_contact_title_cpt_3 ) ) { 

      if ( $nd_travel_meta_box_contact_title_cpt_3 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_contact_title_cpt_3' , $nd_travel_meta_box_contact_title_cpt_3 );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_contact_title_cpt_3');
      }
 
    }

    $nd_travel_meta_box_contact_descr_cpt_3 = sanitize_meta('nd_travel_meta_box_contact_descr_cpt_3',$_POST['nd_travel_meta_box_contact_descr_cpt_3'],'post');
    if ( isset( $nd_travel_meta_box_contact_descr_cpt_3 ) ) { 

      if ( $nd_travel_meta_box_contact_descr_cpt_3 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_contact_descr_cpt_3' , $nd_travel_meta_box_contact_descr_cpt_3 ); 
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_contact_descr_cpt_3');
      }
