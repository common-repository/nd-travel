...
function nd_travel_meta_box_save_cpt_2( $post_id )
{
    ...
    $nd_travel_meta_box_cpt_2_icon = esc_url_raw( $_POST['nd_travel_meta_box_cpt_2_icon'] );
    if ( isset( $nd_travel_meta_box_cpt_2_icon ) ) { 

      if ( $nd_travel_meta_box_cpt_2_icon != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_cpt_2_icon' , $nd_travel_meta_box_cpt_2_icon );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_cpt_2_icon');
      }
   
    }

    $nd_travel_meta_box_cpt_2_color = sanitize_hex_color( $_POST['nd_travel_meta_box_cpt_2_color'] );
    if ( isset( $nd_travel_meta_box_cpt_2_color ) ) { 

      if ( $nd_travel_meta_box_cpt_2_color != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_cpt_2_color' , $nd_travel_meta_box_cpt_2_color );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_cpt_2_color');
      }
    
    }

    $nd_travel_meta_box_cpt_2_text_preview = sanitize_meta('nd_travel_meta_box_cpt_2_text_preview',$_POST['nd_travel_meta_box_cpt_2_text_preview'],'post');
    if ( isset( $nd_travel_meta_box_cpt_2_text_preview ) ) { 

      if ( $nd_travel_meta_box_cpt_2_text_preview != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_cpt_2_text_preview' , $nd_travel_meta_box_cpt_2_text_preview );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_cpt_2_text_preview');
      }
   
    }

    //page settings: sanitize and validate
    $nd_travel_meta_box_image_cpt_2 = esc_url_raw( $_POST['nd_travel_meta_box_image_cpt_2'] );
    if ( isset( $nd_travel_meta_box_image_cpt_2 ) ) { 

      if ( $nd_travel_meta_box_image_cpt_2 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_image_cpt_2' , $nd_travel_meta_box_image_cpt_2 );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_image_cpt_2');
      }
   
    }

    $nd_travel_meta_box_image_cpt_2_position = sanitize_option( 'nd_travel_meta_box_image_cpt_2_position', $_POST['nd_travel_meta_box_image_cpt_2_position'] );
    if ( isset( $nd_travel_meta_box_image_cpt_2_position ) ) { 

      if ( $nd_travel_meta_box_image_cpt_2_position != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_image_cpt_2_position' , $nd_travel_meta_box_image_cpt_2_position ); 
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_image_cpt_2_position');
      }
  
    }

    $nd_travel_meta_box_page_layout_cpt_2 = sanitize_option( 'nd_travel_meta_box_page_layout_cpt_2', $_POST['nd_travel_meta_box_page_layout_cpt_2'] );
    if ( isset( $nd_travel_meta_box_page_layout_cpt_2 ) ) { 

      if ( $nd_travel_meta_box_page_layout_cpt_2 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_page_layout_cpt_2' , $nd_travel_meta_box_page_layout_cpt_2 );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_page_layout_cpt_2');
      }
       
    }
    
    //info box: sanitize and validate
    $nd_travel_meta_box_agent_title_cpt_2 = sanitize_meta('nd_travel_meta_box_agent_title_cpt_2',$_POST['nd_travel_meta_box_agent_title_cpt_2'],'post');
    if ( isset( $nd_travel_meta_box_agent_title_cpt_2 ) ) { 

      if ( $nd_travel_meta_box_agent_title_cpt_2 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_agent_title_cpt_2' , $nd_travel_meta_box_agent_title_cpt_2 );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_agent_title_cpt_2');
      }
   
    }

    $nd_travel_meta_box_agent_descr_cpt_2 = sanitize_meta('nd_travel_meta_box_agent_descr_cpt_2',$_POST['nd_travel_meta_box_agent_descr_cpt_2'],'post');
    if ( isset( $nd_travel_meta_box_agent_descr_cpt_2 ) ) { 

      if ( $nd_travel_meta_box_agent_descr_cpt_2 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_agent_descr_cpt_2' , $nd_travel_meta_box_agent_descr_cpt_2 ); 
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_agent_descr_cpt_2');
      }
   
    }

    $nd_travel_meta_box_contact_title_cpt_2 = sanitize_meta('nd_travel_meta_box_contact_title_cpt_2',$_POST['nd_travel_meta_box_contact_title_cpt_2'],'post');
    if ( isset( $nd_travel_meta_box_contact_title_cpt_2 ) ) { 

      if ( $nd_travel_meta_box_contact_title_cpt_2 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_contact_title_cpt_2' , $nd_travel_meta_box_contact_title_cpt_2 ); 
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_contact_title_cpt_2');
      }
   
    }


    $nd_travel_meta_box_contact_descr_cpt_2 = sanitize_meta('nd_travel_meta_box_contact_descr_cpt_2',$_POST['nd_travel_meta_box_contact_descr_cpt_2'],'post');
    if ( isset( $nd_travel_meta_box_contact_descr_cpt_2 ) ) { 

      if ( $nd_travel_meta_box_contact_descr_cpt_2 != '' ) {
        update_post_meta( $post_id, 'nd_travel_meta_box_contact_descr_cpt_2' , $nd_travel_meta_box_contact_descr_cpt_2 );
      }else{
        delete_post_meta( $post_id,'nd_travel_meta_box_contact_descr_cpt_2');
      }
