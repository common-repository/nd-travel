...
if ( $nd_travel_current_page_permalink == nd_travel_search_page() ) {
    ...
    $nd_travel_shortcode_order_options .= '
      ...
      <script type="text/javascript">
        ...
        .nd_travel_search_filter_layout_grid { background-image:url('.esc_url(plugins_url('icon-grid-grey.svg', __FILE__ )).'); }
        .nd_travel_search_filter_layout_grid.nd_travel_search_filter_layout_active { background-image:url('.esc_url(plugins_url('icon-grid-white.svg', __FILE__ )).'); }

        .nd_travel_search_filter_layout_list.nd_travel_search_filter_layout_active { background-image:url('.esc_url(plugins_url('icon-list-white.svg', __FILE__ )).'); }
        .nd_travel_search_filter_layout_list { background-image:url('.esc_url(plugins_url('icon-list-grey.svg', __FILE__ )).'); }
            ...
            <div class="nd_travel_section nd_travel_position_relative nd_travel_line_height_0">
                ...
                <ul id="nd_travel_search_filter_options" class="nd_travel_list_style_none nd_travel_display_inline_block nd_travel_padding_0 nd_travel_margin_0">
                  <li class="nd_travel_display_inline_block nd_travel_position_relative nd_travel_padding_20 nd_travel_padding_bottom_15 nd_travel_margin_0 nd_travel_float_left">
                      ...
                      <img alt="" class="nd_travel_margin_left_10 nd_travel_float_left" width="10" src="'.esc_url(plugins_url('icon-down-arrow-white.svg', __FILE__ )).'">
