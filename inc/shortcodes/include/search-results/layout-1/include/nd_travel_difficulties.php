      ...
      <!--START difficultys-->
        <div class=" '.$nd_travel_difficulties_class.' nd_travel_width_100_percentage nd_travel_float_left nd_travel_box_sizing_border_box">
          ...
          <div class="nd_travel_section nd_travel_position_relative nd_travel_padding_30 nd_travel_padding_30_15_all_iphone nd_travel_box_sizing_border_box">
                ...
                <img class="nd_travel_toogle_difficulty_open_content nd_travel_position_absolute nd_travel_right_30 nd_travel_top_35 nd_travel_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
                <img style="transform: rotate(180deg);" class="nd_travel_toogle_difficulty_close_content nd_travel_display_none nd_travel_position_absolute nd_travel_right_30 nd_travel_top_35 nd_travel_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
            </div>
