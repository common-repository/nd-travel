...
if ($nd_travel_archive_form_keyword != '') {
	...
	<div class=" nd_travel_archive_form_keyword_content nd_travel_width_100_percentage nd_travel_float_left nd_travel_box_sizing_border_box">
		...
		<div class="nd_travel_section nd_travel_position_relative nd_travel_padding_30 nd_travel_padding_30_15_all_iphone nd_travel_box_sizing_border_box">
			...
			<h3 class="nd_travel_float_left nd_travel_font_weight_normal  nd_travel_font_size_16">'.__('Keyword','nd-travel').' : '.esc_html($nd_travel_archive_form_keyword).' <img id="nd_travel_remove_keyword" width="8" class="nd_travel_cursor_pointer nd_travel_bg_greydark nd_travel_padding_2 nd_travel_border_radius_100_percentage" alt="" src="'.esc_url(plugins_url('icon-close-2-white.svg', __FILE__ )).'"></h3> 
