...
$nd_travel_shortcode_left_content .= '
        ...
        <div class=" '.$nd_travel_durations_class.' nd_travel_width_100_percentage nd_travel_float_left nd_travel_box_sizing_border_box">
              ...
              <div class="nd_travel_section nd_travel_position_relative nd_travel_padding_30 nd_travel_padding_30_15_all_iphone nd_travel_box_sizing_border_box">
                    ...
                    <img class="nd_travel_toogle_durations_open_content nd_travel_position_absolute nd_travel_right_30 nd_travel_top_35 nd_travel_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
                    <img style="transform: rotate(180deg);" class="nd_travel_toogle_durations_close_content nd_travel_display_none nd_travel_position_absolute nd_travel_right_30 nd_travel_top_35 nd_travel_cursor_pointer" alt="" width="12" src="'.esc_url(plugins_url('icon-down-arrow-grey.svg', __FILE__ )).'">
                </div>
        ...
        ';
          ...
          <div class="nd_travel_toogle_durations_content nd_travel_padding_0_30 nd_travel_section nd_travel_display_none  nd_travel_margin_top_10_negative nd_travel_box_sizing_border_box">';
            ...
            <div class="nd_travel_section nd_travel_height_20"></div>
      		...
      		$nd_travel_shortcode_left_content .= '
      		<input type="hidden" id="nd_travel_archive_form_durations" name="nd_travel_archive_form_durations" value="'.esc_attr($nd_travel_cpt_1_tax_1_id_value).'">
