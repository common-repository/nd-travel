...
function nd_travel_shortcode_search_results($nd_travel_ssr_atts) {
    ...
    $nd_travel_sorting_params = array(
        'nd_travel_ajaxurl_sorting' => admin_url('admin-ajax.php'),
        'nd_travel_ajaxnonce_sorting' => wp_create_nonce('nd_travel_sorting_nonce'),
    );

    wp_enqueue_script( 'nd_travel_search_sorting', esc_url( plugins_url( 'sorting.js', __FILE__ ) ), array( 'jquery' ) ); 
    wp_localize_script( 'nd_travel_search_sorting', 'nd_travel_my_vars_sorting', $nd_travel_sorting_params );  

    //default datas
    if( isset( $_GET['nd_travel_archive_form_keyword'] ) ) { $nd_travel_archive_form_keyword = sanitize_text_field($_GET['nd_travel_archive_form_keyword']); } else { $nd_travel_archive_form_keyword = ''; }
    if( isset( $_GET['nd_travel_archive_form_destinations'] ) ) { $nd_travel_archive_form_destinations = sanitize_text_field($_GET['nd_travel_archive_form_destinations']); } else { $nd_travel_archive_form_destinations = ''; }
    if( isset( $_GET['nd_travel_typology_slug'] ) ) { 
        ...
        if ( $_GET['nd_travel_typology_slug'] == '' ) { 
            ...
            $nd_travel_typology_idd = sanitize_text_field($_GET['nd_travel_typology_slug']); 
    ...
    if( isset( $_GET['nd_travel_cpt_1_tax_1'] ) ) { 
        ...
        if ( $_GET['nd_travel_cpt_1_tax_1'] == '' ) { 
            ...
            $nd_travel_cpt_1_tax_1_id = sanitize_text_field($_GET['nd_travel_cpt_1_tax_1']);
    ...
    if( isset( $_GET['nd_travel_cpt_1_tax_2'] ) ) { 
        ...
        if ( $_GET['nd_travel_cpt_1_tax_2'] == '' ) { 
            ...
            $nd_travel_cpt_1_tax_2_id = sanitize_text_field($_GET['nd_travel_cpt_1_tax_2']);
    ...
    if( isset( $_GET['nd_travel_cpt_1_tax_3'] ) ) { 
        ...
        if ( $_GET['nd_travel_cpt_1_tax_3'] == '' ) { 
            ...
            $nd_travel_cpt_1_tax_3_id = sanitize_text_field($_GET['nd_travel_cpt_1_tax_3']);
...
function nd_travel_sorting_php() {
    ...
    check_ajax_referer( 'nd_travel_sorting_nonce', 'nd_travel_sorting_security' );


    //recover atts
    $nd_travel_qnt_posts_per_page = sanitize_text_field($_GET['nd_travel_pagination']);
    $nd_travel_price = sanitize_text_field($_GET['nd_travel_price']);
    $nd_travel_layout = sanitize_text_field($_GET['nd_travel_layout']);

    //recover var
    $nd_travel_paged = sanitize_text_field($_GET['nd_travel_paged']);
    $nd_travel_archive_form_destinations = sanitize_text_field($_GET['nd_travel_archive_form_destinations']);
    $nd_travel_archive_form_typologys = sanitize_text_field($_GET['nd_travel_archive_form_typologys']);
    $nd_travel_archive_form_max_price_for_day = sanitize_text_field($_GET['nd_travel_archive_form_max_price_for_day']);
    $nd_travel_archive_form_durations = sanitize_text_field($_GET['nd_travel_archive_form_durations']);
    $nd_travel_archive_form_difficultys = sanitize_text_field($_GET['nd_travel_archive_form_difficultys']);
    $nd_travel_archive_form_minages = sanitize_text_field($_GET['nd_travel_archive_form_minages']);
    $nd_travel_archive_form_date = sanitize_text_field($_GET['nd_travel_archive_form_date']);
    $nd_travel_archive_form_keyword = sanitize_text_field($_GET['nd_travel_archive_form_keyword']);
    $nd_travel_archive_form_promo_price = sanitize_text_field($_GET['nd_travel_archive_form_promo_price']);
    $nd_travel_search_filter_layout = sanitize_text_field($_GET['nd_travel_search_filter_layout']);
    $nd_travel_search_filter_options_meta_key = sanitize_text_field($_GET['nd_travel_search_filter_options_meta_key']);
    $nd_travel_search_filter_options_order = sanitize_text_field($_GET['nd_travel_search_filter_options_order']);
    ...
    <div id="nd_travel_content_result" class="nd_travel_section">';
        ...
        <div id="nd_travel_search_cpt_1_no_results" class="nd_travel_section nd_travel_padding_15 nd_travel_box_sizing_border_box">
            <div class="nd_travel_section nd_travel_bg_yellow nd_travel_padding_15_20 nd_travel_box_sizing_border_box">
              <img class="nd_travel_float_left nd_travel_display_none_all_iphone" width="20" src="'.esc_url(plugins_url('icon-warning-white.svg', __FILE__ )).'">
