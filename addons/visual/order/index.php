...
{  
  ...
  if ( $nd_travel_arrow_image == '' ) { 
    $nd_travel_arrow_image_src = esc_url(plugins_url('icon-down-arrow-white.svg', __FILE__ ));
  }else{
    $nd_travel_arrow_image_src = wp_get_attachment_image_src($nd_travel_arrow_image,'large');
  }

  if ( $nd_travel_list_image == '' ) { 
    $nd_travel_list_image_src = esc_url(plugins_url('icon-list-white.svg', __FILE__ ));
  }else{
    $nd_travel_list_image_src = wp_get_attachment_image_src($nd_travel_list_image,'large');
  }

  if ( $nd_travel_grid_image == '' ) { 
    $nd_travel_grid_image_src = esc_url(plugins_url('icon-grid-grey.svg', __FILE__ ));
  }else{
...
function nd_travel_order() {
  ...
  //END get all layout
   ...
   vc_map( array(
      ...
      "icon" => esc_url(plugins_url('order.jpg', __FILE__ )),
      "class" => "",
