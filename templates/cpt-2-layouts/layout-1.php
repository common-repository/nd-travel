	...
	while(have_posts()) : the_post();
			...
			$nd_travel_cpt_2_packages_section .= '
    			...
    			<div id="nd_travel_single_cpt_2_info_packages" class="nd_travel_section nd_travel_position_relative ">
			        ...
			        <img style="background-color:'.$nd_travel_meta_box_cpt_2_color.';" alt="" class="nd_travel_position_absolute nd_travel_bg_greydark nd_travel_left_0 nd_travel_padding_10 nd_travel_top_0" width="25" src="'.esc_url(plugins_url('icon-planet-earth-white.png', __FILE__ )).'">
    		...
    		if ( $nd_travel_meta_box_agent_title_cpt_2 != '' ) {
		    	...
		    	$nd_travel_cpt_2_agent_section .= '
	    			...
	    			<div id="nd_travel_single_cpt_2_info_agent" class="nd_travel_section nd_travel_position_relative nd_travel_margin_top_20">
				        ...
				        <img style="background-color:'.$nd_travel_meta_box_cpt_2_color.';" alt="" class="nd_travel_position_absolute nd_travel_left_0 nd_travel_padding_10 nd_travel_top_0" width="25" src="'.esc_url(plugins_url('icon-user-white.png', __FILE__ )).'">
    		...
    		if ( $nd_travel_meta_box_contact_title_cpt_2 != '' ) {
		    	...
		    	$nd_travel_cpt_2_contact_section .= '
	    			...
	    			<div id="nd_travel_single_cpt_2_info_contact" class="nd_travel_section nd_travel_position_relative nd_travel_margin_top_20">
				        ...
				        <img style="background-color:'.$nd_travel_meta_box_cpt_2_color.';" alt="" class="nd_travel_position_absolute nd_travel_left_0 nd_travel_padding_10 nd_travel_top_0" width="25" src="'.esc_url(plugins_url('icon-message-white.svg', __FILE__ )).'">
